...
class Main {
  ...
  Main.fromJson(dynamic json) {
    if (json['temp'] == null) {
      _temp = 0;
    } else if (json['temp'] is double) {
      _temp = (json['temp'] as double).toInt();
    } else if (json['temp'] is int) {
      _temp = json['temp'];
    } else {
      throw Exception();
    }
    ...
    if (json['feels_like'] == null) {
      _feelsLike = 0;
    } else if (json['feels_like'] is double) {
      _feelsLike = (json['feels_like'] as double).toInt();
    } else if (json['feels_like'] is int) {
    ...
    if (json['temp_min'] == null) {
      _tempMin = 0;
    } else if (json['temp_min'] is double) {
      _tempMin = json['temp_min'];
    } else if (json['temp_min'] is int) {
      _tempMin = (json['temp_min'] as int).toDouble();
    } else {
      throw Exception();
    }
    if (json['temp_min'] == null) {
      _tempMax = 0;
    } else if (json['temp_max'] is double) {
      _tempMax = json['temp_max'];
    } else if (json['temp_max'] is int) {
      _tempMax = (json['temp_max'] as int).toDouble();
    } else {
      throw Exception();
    }
